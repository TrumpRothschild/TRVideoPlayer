...
class TRVideoPlayerHeaderView: UIView {
    ...
    required init(configuration: TRConfiguration, theme: TRTheme, delegate: TRVideoPlayerControlsDelegate?) {
