 ...
 */
public enum TRVideoPlayerState {
    case readyToPlay
    case playing
    case pause
    case playedToTheEnd
...
*/
public protocol TRVideoPlayerControlsDelegate where Self: UIView {
    
    var playerStateDidChange: ((_ state: TRVideoPlayerState)->())? {get set}
