...
open class TRVideoPlayerView: UIView {
    
    // MARK: - Constants

    public var playerStateDidChange: ((TRVideoPlayerState)->())? = nil
    ...
    let overlayView = TRVideoPlayerControls()
    
    var configuration: TRConfiguration = MainConfiguration()
    
    var theme: TRTheme = MainTheme()
    ...
    required public init(configuration: TRConfiguration?, theme: TRTheme?, header: UIView?) {
...
extension TRVideoPlayerView: TRVideoPlayerControlsDelegate {
...
extension TRVideoPlayerView: UIGestureRecognizerDelegate {
